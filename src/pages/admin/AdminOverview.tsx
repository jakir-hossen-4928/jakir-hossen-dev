            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                <Card className="bg-primary/5 border-primary/20 backdrop-blur-md relative overflow-hidden group">
                    ...
                    <CardContent className="p-4 pt-0">
                        <p className="text-3xl font-black text-foreground">{totalAppsCount}</p>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-yellow-500/5 border-yellow-500/20 backdrop-blur-md relative overflow-hidden group">
                    ...
                    <CardHeader className="p-4 pb-2 flex flex-row items-center justify-between">
                        ...
                        <NotebookPen size={14} className="text-yellow-500/40" />
                    </CardHeader>
                    <CardContent className="p-4 pt-0">
                        <p className="text-3xl font-black text-foreground">{notes.length}</p>
                    </CardContent>
                </Card>
            </div>
